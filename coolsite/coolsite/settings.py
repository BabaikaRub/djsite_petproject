...
SECRET_KEY = 'django-insecure-ugklas0mio_-6cg%36yxw1sb@8r2mchq+x-*wea=5ek4230ap('
...
INSTALLED_APPS = [
    ...
    'women.apps.WomenConfig', # прорисываем такую конструкцию для того,
    # чтобы потом удобно было конфигурировать apps.py для этого приложения
]
